...
class ThemePara extends StatefulWidget {
  @override
  ThemeParaState createState() => ThemeParaState();
}

class ThemeParaState extends State<ThemePara> {
  ...
  void changeParagraph() {
    setState(() {
      paragraph = english.ParaMaker().authorPara(_authorController.text,
          _pointController.text, _storyController.text, _quoteController.text);
    });
  }
